...
<div class="source-matrix">
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/source-texts/theory-calculation-transient-electric-phenomena-oscillations/chapter-24/">Read the source chapter<span>Open the OCR-derived source text where the permanent/transient distinction is introduced.</span></a>
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/chapter-workbench/theory-calculation-transient-electric-phenomena-oscillations/chapter-24/">Open the workbench<span>Review equation candidates, figure candidates, concept hits, glossary hits, and promotion tasks.</span></a>
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/diagrams/visual-topic-galleries/transients-surges-oscillations/">Open transient visuals<span>Use guide diagrams for decay, oscillation, line surges, and source-routed figure candidates.</span></a>
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/mathematics/equation-atlas/transients-oscillation/">Open transient formulas<span>Review formula candidates for exponential decay, oscillation, damping, decrement, and natural periods.</span></a>
</div>
