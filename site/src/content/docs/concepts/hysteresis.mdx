...
The archive should eventually include Steinmetz's empirical hysteresis law and compare it to modern core-loss models. That work must preserve his original notation and units before translating into modern form.
