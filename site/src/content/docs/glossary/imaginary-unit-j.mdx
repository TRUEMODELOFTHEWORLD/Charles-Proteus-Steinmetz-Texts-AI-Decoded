...
<div class="source-matrix">
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/diagrams/visual-topic-galleries/ac-symbolic-geometry/">Open AC symbolic visual route<span>Modern guide diagrams, original AC crops, figure candidates, formula families, and workbench pages for symbolic geometry.</span></a>
  <a href="/Charles-Proteus-Steinmetz-Texts-AI-Decoded/mathematics/equations/symbolic-operator-j/">Open equation page<span>Focused equation note for `j`, quadrature, and quarter-period rotation.</span></a>
</div>
