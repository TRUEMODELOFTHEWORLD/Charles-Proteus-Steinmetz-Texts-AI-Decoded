...
The first public controls for this standard are now live: citation/data exports, editorial policy, canonical review workflow, notation ledger, diagram provenance ledger, schema reference, and expert review packets. They do not finish the scholarship by themselves; they make the remaining scholarship visible and repeatable.
