...
The duration To is the ratio of the energy-storage coefficient 
...
where Iq = maximum value of transient current. 
...
This gives a relation between the maximum value of transient 
...
U V c 
-^ therefore is of the nature of an impedance z^^ and is called 
the natural impedance, or the surge im'pedance, of the circuit ; and 

Ic 

its reciprocal, \ j = Vq, is the natural admittance, or the surge 
...
iQ = e^yo, where eo = voltage between cable conductor and ground. 
...
discharge current in the line is limited to Iq = eoyo. 
...
high and 2/0 low. That is, a high transient voltage can produce 
...
mined), and y the phase angle at the starting moment of the 
transient; that is, 

^l = ^o cos 7 = initial transient current. (14) 

As the current iissi maximum at the moment when the magnetic 
...
on of Magnetic and Dielectric Energy of Transient. 


ies to the dielectric energy. If all the energy 
...
Inductance, L = 1.25 mh = 1.25 X 10~^ henrys; 

Capacity, C = 2mf = 2 X 10'^ farads; 
...
The initial transient voltage, ei = 2000 volts. 
...
The dielectric-energy transient, k = e~^-, 
And the resultant transient, hk = e~^K 

And Fig. 33 C gives the transient current, i = hki' , and the tran- 
sient voltage, e = hke'.
