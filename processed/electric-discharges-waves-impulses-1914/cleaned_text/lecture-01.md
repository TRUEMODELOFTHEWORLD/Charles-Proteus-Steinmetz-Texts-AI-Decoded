...
i\ and possibly different voltages e' ', but again i' and e' are per- 
...
"A ELECTRIC DISCHARGES, WAVES AND IMPULSES. 

condenser C is charged, the current in the Hne A and the condenser 
...
stored in the sj^stem. If we now close the switch, before the 
...
NATURE AND ORIGIN OF TRANSIENTS. 5 
...
value, 12, it would traverse a curve i', which is the same as curve 
...
i^ is proportional to i, from any point t onward curve i is propor- 
tional to the same curve i from ti onward. At time ti, it is 

di2 _ dii 12 
dti dti ii 

But since -i^ and 4 at h are the same as -r and i at time t, it 
dti dt ' 
...
where c = — ^ ^ = constant, and the minus sign is chosen, as 
...
that is, c is the reciprocal of the projection T = tih on the zero hne 
...
din 
is proportional to the amount of radiating material; it is -t- = cm, 
...
energy in the m_omentum of the motor. 

6. The study and calculation of the permanent phenomena in 
electric circuits arc usually far simpler than are the study and 
